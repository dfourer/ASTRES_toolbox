function resimf = prox_emd_2D_P2DLC(data, dec, func, grad_prox, param, k)
...
for n = 1:param.Lmax
    ...
    x2tilde = x2 - tau*(grad_prox.g(x1,x2) + dec.T2_adj(y12) + dec.T3_adj(y13));
    ...
    crit(n)  = func.g(x1,x2) + func.f1(x1,lambda_geometry) + func.f2(x2,lambda_texture_l) + func.f3(x2,lambda_texture_c);
