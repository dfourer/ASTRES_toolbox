function [tfr,t,f] = tfr_stft(x,t,N,h,trace)
%TFR_STFT	STFT time-frequency Representation.
%	[TFR,T,F]=TFRSP(X,T,N,H,TRACE) computes the STFT 
...
%	        output arguments, TFR_STFT runs TFRQVIEW.
...
%
%        [tfr,t,freq]=tfr_stft(sig,1:128,64,h,1); plot(fftshift(freq),fftshift(abs(tfr(:,100))))
%
